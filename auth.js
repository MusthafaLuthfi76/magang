...
const AUTH = (() => {
    ...
    const PAGES = {
        ...
        'admin-requests.html': 'kendaraan',
        'admin-voucher-bbm.html': 'voucher',
        'admin-ruang-rapat.html': 'ruang_rapat',
        'admin-kearsipan.html': 'kearsipan',
        'admin-spj-keuangan.html': 'penilaian_spj',
        'admin-spj-pengumpulan.html': 'pengumpulan_spj',
        'admin-pengajuan-dana.html': 'pengajuan_dana',
        'admin-penilaian-monev.html': 'penilaian_monev',
    ...
    const ROLE_HOME = {
        ...
        subumum: 'admin-dashboard.html',
        subkeuangan: 'admin-spj-pengumpulan.html',
        sekretariat: 'admin-penilaian-monev.html',
    };
